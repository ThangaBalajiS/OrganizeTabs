                                ...
                                if (isConfirm) {
                                    ...
                                    gameScore.save()
                                        .then((gameScore) => {
                                            ...
                                            modal.innerHTML = '';
                                            modal.innerHTML += '<div class="modal-ulla"><div class="modal-site-padam" style="background:url(https://api.qrserver.com/v1/create-qr-code/?data=https%3A%2F%2Finfinite-tabs-manager.herokuapp.com%2F%3FsecureCode%3D' + url + '&amp;size=150x150&amp);background-size:contain;" ></div><div class="share-modal-details" ><div class="sahre-title" >Untitled</div><div><div class="share-right-item share-desc" >Share this link or scan QR Code to view tabs in mobile</div><div class="share-right-item url" > <input type="text" style="width:100%;"  value="https%3A%2F%2Finfinite-tabs-manager.herokuapp.com/?secureCode=' + url + '" id="myInput"> </div></div><div class="share-right-item cpy-btn" ><div class="copy-url-btn"> Copy URL </div><div class="url-gone-notice" >Will be valid till August 13 00:00 GMT</div></div></div>';
                                            setTimeout(function () {
                                                $('.copy-url-btn').off()
